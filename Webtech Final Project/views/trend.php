...
<table border="1" cellspacing="0" align="center" cellpadding="5">
    ...
    <tr>
        ...
        <td><?=$data['Total_Return']?></td> 
             ...
             <td> <button style="background-color: #4caf50; color: #fff; padding: 8px 12px; border: none; border-radius: 4px; text-decoration: none; cursor: pointer;">
    <a href="trend.php?id=<?=$id?>" style="color: #fff; text-decoration: none;">Trend Books</a>
</button>
...
<h2><form align="center">
    <fieldset>
            ...
            <br />
            Author     :
           <input type="text" name="rating" id="email"  name="email" value="<?php echo $Author;?>"  />
    ...
    value="TREND"
    onclick="validate()"
    style="background-color: #4caf50; color: #fff; padding: 8px 12px; border: none; border-radius: 4px; cursor: pointer;"
/><br />
